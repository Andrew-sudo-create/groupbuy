  ...
  const res = await fetch(
    `https://generativelanguage.googleapis.com/v1beta/models/${MODEL}:generateContent`,
    {
      ...
      body: JSON.stringify({
        ...
        // thinkingBudget: 0 — these are short, single-shot completions; without
        // this, Gemini 2.5's internal reasoning can eat the whole maxOutputTokens
        // budget and leave nothing for the actual answer.
